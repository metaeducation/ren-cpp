// WARNING: This file contains modifications to work with RenCpp framework
// as well as modifications from https://github.com/Morwenn/POLDER/
//
...
int main (int argc, char ** argv) { // should be const char *, Rebol conflicts
